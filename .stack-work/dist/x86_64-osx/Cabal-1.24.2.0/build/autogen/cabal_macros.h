...
/* package sem1-0.1.0.0 */
#define VERSION_sem1 "0.1.0.0"
#define MIN_VERSION_sem1(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "sem1-0.1.0.0"

#define CURRENT_PACKAGE_KEY "sem1-0.1.0.0"
