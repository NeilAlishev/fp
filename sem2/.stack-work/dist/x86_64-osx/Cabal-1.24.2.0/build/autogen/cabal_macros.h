...
/* package sem2-0.1.0.0 */
#define VERSION_sem2 "0.1.0.0"
#define MIN_VERSION_sem2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "sem2-0.1.0.0"

#define CURRENT_PACKAGE_KEY "sem2-0.1.0.0"
